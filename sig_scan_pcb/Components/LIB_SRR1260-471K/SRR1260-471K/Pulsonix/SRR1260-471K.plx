...
//635680/1265179/2.50/2/4/Inductor
...
(library Library_1
	...
	(symbolDef "SRR1260-471K" (originalName "SRR1260-471K")
	...
	(compDef "SRR1260-471K" (originalName "SRR1260-471K") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SRR1260-471K"))
		...
		(attr "Mouser Part Number" "652-SRR1260-471K")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Bourns/SRR1260-471K?qs=brMhP%2FMjUfcBWA8PXUduFQ%3D%3D")
		(attr "Manufacturer_Name" "Bourns")
		(attr "Manufacturer_Part_Number" "SRR1260-471K")
		(attr "Description" "Inductor Power Shielded Wirewound 470uH 10% 1KHz 18Q-Factor Ferrite 0.95A 0.82Ohm DCR T/R")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/SRR1260-4R7Y.pdf")
		(attr "<Component Height>" "6.5")
		(attr "<STEP Filename>" "SRR1260-471K.stp")
